...
public sealed class SequenceAndSkip<T1, T2> : Parser<T1>
{
...
public sealed class SequenceAndSkip<T1, T2, T3> : Parser<(T1, T2)>
{
    ...
    public SequenceAndSkip(Parser<(T1, T2)>
        parser,
...
public sealed class SequenceAndSkip<T1, T2, T3, T4> : Parser<(T1, T2, T3)>
{
    private readonly Parser<(T1, T2, T3)> _parser;
    internal readonly Parser<T4> _lastParser;

    public SequenceAndSkip(Parser<(T1, T2, T3)> parser, Parser<T4> lastParser)
    {
        _parser = parser;
        _lastParser = lastParser ?? throw new ArgumentNullException(nameof(lastParser));
    }
...
public sealed class SequenceAndSkip<T1, T2, T3, T4, T5> : Parser<(T1, T2, T3, T4)>
{
    private readonly Parser<(T1, T2, T3, T4)> _parser;
    internal readonly Parser<T5> _lastParser;

    public SequenceAndSkip(Parser<(T1, T2, T3, T4)> parser, Parser<T5> lastParser)
    {
        _parser = parser;
        _lastParser = lastParser ?? throw new ArgumentNullException(nameof(lastParser));
    }
...
public sealed class SequenceAndSkip<T1, T2, T3, T4, T5, T6> : Parser<(T1, T2, T3, T4, T5)>
{
    private readonly Parser<(T1, T2, T3, T4, T5)> _parser;
    internal readonly Parser<T6> _lastParser;

    public SequenceAndSkip(Parser<(T1, T2, T3, T4, T5)> parser, Parser<T6> lastParser)
    {
        _parser = parser;
        _lastParser = lastParser ?? throw new ArgumentNullException(nameof(lastParser));
    }
...
public sealed class SequenceAndSkip<T1, T2, T3, T4, T5, T6, T7> : Parser<(T1, T2, T3, T4, T5, T6)>
{
    private readonly Parser<(T1, T2, T3, T4, T5, T6)> _parser;
    internal readonly Parser<T7> _lastParser;

    public SequenceAndSkip(Parser<(T1, T2, T3, T4, T5, T6)> parser, Parser<T7> lastParser)
    {
        _parser = parser;
        _lastParser = lastParser ?? throw new ArgumentNullException(nameof(lastParser));
    }
...
public sealed class SequenceAndSkip<T1, T2, T3, T4, T5, T6, T7, T8> : Parser<(T1, T2, T3, T4, T5, T6, T7)>
{
    private readonly Parser<(T1, T2, T3, T4, T5, T6, T7)> _parser;
    internal readonly Parser<T8> _lastParser;

    public SequenceAndSkip(Parser<(T1, T2, T3, T4, T5, T6, T7)> parser, Parser<T8> lastParser)
    {
        _parser = parser;
        _lastParser = lastParser ?? throw new ArgumentNullException(nameof(lastParser));
    }
